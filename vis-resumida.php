...
<?php
     ...
     if (isset($_SERVER['HTTP_REFERER']) == true) {
          if (limpa_pro($_SESSION['wrknompro']) != limpa_pro($_SERVER['HTTP_REFERER'])) {
               ...
               $ret = gravar_log(1,"Entrada na página de relatório de vistoria resumida Pallas.33 - Gestão em Mall");  
          }
     }
...
<body id="box00">
     <h1 class="cab-0">Relatório de Vistorias Resumido</h1>
     ...
     <div class="row">
          ...
          <div class="col-md-10">
               <div class="qua-3 container-fluid">
                    <div class="row lit-3">
                         <div class="col-md-12">
                              <label>Relatório de Vistorias Resumido</label>
                         </div>
                    </div>
...
function carrega_vis($loj, $dti, $dtf, $tip) {
     ...
     $com .= " where idshopping = " . $_SESSION['wrkcodemp'] . " and visdataefe between '" . $dti . "' and '" . $dtf . "' ";
